...
1\) Remove initial keys, deployment account's address, and HomeOwner's address from `Certifier` contract calling its `revoke` method. [How to call contract's method with MEW.](5-reconfigure-instances.md#call-contract-methods-using-mycrypto)
