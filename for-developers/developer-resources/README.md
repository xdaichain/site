...
POSDAO consensus is implemented in Solidity. Proxy contracts should be read for values such as [Random Numbers](../on-chain-random-numbers/) generated by the protocol. A list of current contracts is [available here](https://github.com/poanetwork/poa-chain-spec/blob/dai/contracts.json#L9).
