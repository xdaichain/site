...
{% hint style="warning" %}
Up**dated Oct 8, 2020 8:00 pm UTC**: The xDai bridge has been updated to give users control over the withdrawal process and prevent bridge drains. [More information is here](https://forum.poa.network/t/important-changes-in-a-user-interaction-with-the-xdai-bridge/3906).   
