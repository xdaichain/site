...
{% hint style="warning" %}
**Updated Oct 8, 2020 8:00 pm UTC**: The xDai bridge has been updated to decentralize withdrawals and give users more when transferring xDai to Dai on Ethereum. [More information is here](https://forum.poa.network/t/important-changes-in-a-user-interaction-with-the-xdai-bridge/3906).   
