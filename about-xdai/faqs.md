...
* Users are worldwide, from the crypto initiated to first-time users.
...
* The xDai coin is used for stable transactions and low, stable fees. It can also be used to back on-chain tokens \(use cases for this include Event Currencies and Community Currencies\)
...
* [xDai Past](https://forum.poa.network/t/xdai-the-birth-of-the-stable-chain/2812)
* [xDai Future](roadmap.md)

### Where is xDai?

xDai is a stablechain located within the Ethereum ecosystem. xDai users are located around the world, from small gatherings, to 1000+ participant conferences, to networks of villages in Kenya. 
...
xDai also supports a decentralized, earth-friendly architecture with POSDAO consensus and the STAKE consensus staking currency.
...
Imagine every time you needed to pay for lunch you had to use 2 different currencies. On top of that, one of those currencies was not stable, so you didn’t know if you would have to pay an extra $.05 cents or an extra $.50 in fees for the same $10.00 burger. 
...
### I want to be a Staker! How much STAKE will I need?

Public staking is scheduled for Q3, 2020. Minimum amounts needed to validate or delegate on the xDai chain.
...
* From an exchange. Currently STAKE is offered at BitMax

### What is the STAKE contract address?

The Ethereum Mainnet contract address is: [0x0Ae055097C6d159879521C384F1D2123D1f195e6](https://etherscan.io/token/0x0Ae055097C6d159879521C384F1D2123D1f195e6)

I got some STAKE but can't find it in my wallet. 
